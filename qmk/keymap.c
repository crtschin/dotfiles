...
/* FN
 * ,-----------------------------------------------------------------------------------.
 * | ____ | XXXX | XXXX | XXXX | XXXX | XXXX | XXXX | XXXX | XXXX | INS  | DEL  | ____ |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_FN] = LAYOUT_planck_grid(
    ...
    _______, XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,KC_LPRN, KC_RPRN, KC_SCLN,   KC_PGUP, KC_BSLS,
...
[_NUM] = LAYOUT_planck_grid(
    KC_GRV  ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,KC_1    ,KC_2    ,KC_3    ,KC_0    ,XXXXXXX,
